...
@IonicPage()
@Component({
  selector: 'page-actualizardatos',
  templateUrl: 'actualizardatos.html',
  ...
  Actualizar(){
    ...
    .then(data => {
     ...
     console.log("empleado cedula",user = datos.data.empleado.cedula) 
      ...
      this.loader.dismiss();
      console.log("idempleado antes del actualizado",localStorage["id_empleado"]);
      this.PerfilProvider.Actualizado(localStorage["id_empleado"]).then(data => {
        console.log("actualizado user valor 0",data);
      })
